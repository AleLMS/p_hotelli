...
<html lang="en">
    ...
    <div id="mainContainer">
        ...
        <form id="searchForm" name="searchForm" class=" rounded-2 p-2 pt-md-4 pb-md-4 m-0 row" style=" background-color: #9cda71;"
          method="get" action="varaus/varaus.html">
          <p class="h3 text-center pt-2 pb-2" style="">Hae majoitusta</p>
            ...
            <div class="col-12 col-lg-2 mt-0 mt-md-2 mt-lg-0" style="">
                <input class="btn btn-outline-primary" type="submit" id="sendSearch" name="sendSearch" value="Hae"
                style="width: 100%; ">
            </div>
